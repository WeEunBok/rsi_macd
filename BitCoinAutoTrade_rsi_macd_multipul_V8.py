...
while True:
    try:
        ...
        if krw == 0:
            if (macd_price1.macd[199] - macd_price1.macd[198]) >= 0 and (macd_price1.macd[198] - macd_price1.macd[197]) >= 0 and (macd_price1.macd[197] - macd_price1.macd[196]) < 0 and macd_price1.macd_osc[198] < 0 and rsi_arr[186] < 35 and ((macd_price3.macd[198] - macd_price3.macd[197]) >= 0 and macd_price3.macd_osc[198] < 0):
                #krw = current_krw / 100
                krw = 100000
